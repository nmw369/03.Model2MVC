...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<c:forEach var ="purchase" items="${list}">
		...
		<tr class="ct_list_pop">
			...
			<td></td> 
			<td align="left">
				<a href="/getProduct.do?prodNo=${purchase.purchaseProd.prodNo}&menu=${menu}"> ${purchase.purchaseProd.prodName} </a>
			</td>
			<td></td>
			<td align="left">${purchase.purchaseProd.price}</td>
			<td></td>
			<td align="left">${purchase.purchaseProd.manuDate}</td>
			<td></td>
			<td align="left">
				<c:if test="${ ! empty purchase.tranCode && purchase.tranCode == '0' }">
				판매중
				</c:if>
